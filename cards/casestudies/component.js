{{> cards/card_component componentName='casestudies' }}

class casestudiesCardComponent extends BaseCard['casestudies'] {
  ...
  static defaultTemplateName (config) {
    return 'cards/casestudies';
  }
}

ANSWERS.registerTemplate(
  'cards/casestudies',
  `{{{read 'cards/casestudies/template' }}}`
);
ANSWERS.registerComponentType(casestudiesCardComponent);

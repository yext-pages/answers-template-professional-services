{{> cards/card_component componentName='blogs' }}

class blogsCardComponent extends BaseCard['blogs'] {
...
ANSWERS.registerTemplate(
  'cards/blogs',
  `{{{read 'cards/blogs/template' }}}`
);
ANSWERS.registerComponentType(blogsCardComponent);

{{> cards/card_component componentName='services' }}

class servicesCardComponent extends BaseCard['services'] {
...
ANSWERS.registerTemplate(
  'cards/services',
  `{{{read 'cards/services/template' }}}`
);
ANSWERS.registerComponentType(servicesCardComponent);
